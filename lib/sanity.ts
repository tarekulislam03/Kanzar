...
export const FALLBACK_JEWELLERY_ITEMS: JewelleryItem[] = [
  ...
  },
  {
    ...
    category: 'earrings',
    material: '22K Antique Gold with Rubies & Seed Pearls',
    images: ['/images/catalog-2.png'],
    shortDescription: 'Classic moon-shaped chandbali jhumkas layered with delicate seed pearls and sparkling gold filigree.',
    priceDisplay: 'Price On Request',
    karat: '22K Gold',
  },
  {
