...
export default function InvitationCard() {
  ...
  const handleShare = async () => {
    ...
    const shareText = `You are cordially invited to the Grand Opening of Kanzar Jewels Flagship Atelier in Kolkata.\n\n✨ Invitation Link:\n${webUrl}\n\n📸 Follow us on Instagram:\n${instagramUrl}`
  ...
  const copyText = (text?: string) => {
    if (typeof window !== 'undefined') {
      ...
      const instagramUrl = 'https://www.instagram.com/kanzar_jewels?stkn=MTB1bmdxYm9hcjQwNQ%3D%3D'
      const content = text || `You are cordially invited to the Grand Opening of Kanzar Jewels Flagship Atelier in Kolkata.\n\n✨ Invitation Link:\n${webUrl}\n\n📸 Follow us on Instagram:\n${instagramUrl}`
